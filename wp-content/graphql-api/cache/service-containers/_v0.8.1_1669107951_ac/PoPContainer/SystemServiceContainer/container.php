...
class SystemServiceContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            'GraphQLAPI\\GraphQLAPI\\ConditionalOnContext\\Admin\\SystemServices\\TableActions\\ModuleListTableAction' => 'getModuleListTableActionService',
    ...
    /**
     * Gets the public 'GraphQLAPI\GraphQLAPI\ConditionalOnContext\Admin\SystemServices\TableActions\ModuleListTableAction' shared autowired service.
     *
     * @return \GraphQLAPI\GraphQLAPI\ConditionalOnContext\Admin\SystemServices\TableActions\ModuleListTableAction
     */
    protected function getModuleListTableActionService()
    {
        return $this->services['GraphQLAPI\\GraphQLAPI\\ConditionalOnContext\\Admin\\SystemServices\\TableActions\\ModuleListTableAction'] = new \GraphQLAPI\GraphQLAPI\ConditionalOnContext\Admin\SystemServices\TableActions\ModuleListTableAction();
    }
    ...
    protected function getServiceInstantiatorInterfaceService()
    {
        ...
        $instance->addService(($this->services['GraphQLAPI\\GraphQLAPI\\ConditionalOnContext\\Admin\\SystemServices\\TableActions\\ModuleListTableAction'] ?? ($this->services['GraphQLAPI\\GraphQLAPI\\ConditionalOnContext\\Admin\\SystemServices\\TableActions\\ModuleListTableAction'] = new \GraphQLAPI\GraphQLAPI\ConditionalOnContext\Admin\SystemServices\TableActions\ModuleListTableAction())));
