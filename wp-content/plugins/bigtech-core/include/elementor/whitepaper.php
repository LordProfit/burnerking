 ...
 * @since 1.0.0
 */
class TP_Whitepaper extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Whitepaper', 'tpcore'),
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => tp_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Read Bigtech Documents', 'tpcore'),
                'placeholder' => esc_html__('Type Heading Text', 'tpcore'),
                'label_block' => true,
            ]
        );
        ...
        $this->start_controls_section(
            'tg_whitepaper',
            [
                'label' => esc_html__('Whitepaper List', 'tpcore'),
        ...
        $repeater->add_control(
            'tg_whitepaper_title', [
                ...
                'default' => esc_html__('White Paper', 'tpcore'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'tg_whitepaper_list',
            [
                'label' => esc_html__('All - List', 'tpcore'),
                'type' => \Elementor\Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'tg_whitepaper_title' => esc_html__('White Paper', 'tpcore'),
                    ],
                    [
                        'tg_whitepaper_title' => esc_html__('Privacy & Policy', 'tpcore'),
                    ],
                    [
                        'tg_whitepaper_title' => esc_html__('Terms Of Coin Sale', 'tpcore'),
                    ],
                    [
                        'tg_whitepaper_title' => esc_html__('One Pager', 'tpcore'),
                    ],
                ],
                'title_field' => '{{{ tg_whitepaper_title }}}',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Download Doc', 'tpcore'),
        ...
        $this->add_control(
            ...
            [
                ...
                'show_external' => false,
                'default' => [
                    'url' => 'https://drive.google.com/file/d/13B2QZTlvtcdlkR9O28ldB8tT8iR0pcK1/view',
                    'is_external' => true,
                    'nofollow' => true,
                    'custom_attributes' => '',
                ],
                    ...
                    <div class="col-lg-5 col-md-7">
                        <div class="document-content mt-50 wow fadeInRight" data-wow-delay=".2s">
                            ...
                            <ul class="document-list">
                                <?php foreach ($settings['tg_whitepaper_list'] as $item) : ?>
                                    <li><?php echo tp_kses( $item['tg_whitepaper_title'] ); ?></li>
                                <?php endforeach; ?>
                            </ul>
...
$widgets_manager->register( new TP_Whitepaper() );